...
void pileupcomparison(){
    ...
    TFile* fhipu = TFile::Open("output_hipileup/MergedOutput.root");
    TH1D* hipu = (TH1D*)fhipu->Get("hTrkPt");

    TFile* flopu = TFile::Open("output_lowpileup/MergedOutput.root");
    ...
    l->AddEntry(hipu, "High Pileup - 394270 [30, 90] PU = 0.1300", "l");
    l->AddEntry(hlopu, "Low Pileup - 394270 [1, 10] PU = 0.0617", "l");
